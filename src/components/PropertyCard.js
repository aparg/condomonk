          ...
          <div className="flex flex-col overflow-hidden transition-all duration-200 transform bg-white border border-gray-100 group p-0 hover:shadow-lg hover:-translate-y-1 relative">
            ...
            <div className="flex-1 sm:px-5 py-3 ">
              ...
              <span className={`text-black text-xs ${small && "hidden"}`}>
                <div className="flex flex-row justify-start card-feature">
                  {curElem.Bedrooms && (
              ...
              <div className="text-gray-500 font-medium truncate text-ellipsis text-xs mt-2">
                Marketed By {curElem.ListBrokerage}
              </div>
